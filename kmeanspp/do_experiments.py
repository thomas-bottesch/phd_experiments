...
from kmeanspp import result_evaluation_kmeanspp
from latex_plots_kmeanspp import create_plot
from latex_plots_table import create_table
...
def evaluate(run_identifier, control_params, params, function_to_evaluate, out_folder, force = False):
  try:
    ...
    if previous_result is not None and not force:
      ...
      experiment_db.add_experiment(control_params, params, res, exclude_keys_from_json=['init_params'])
      return (control_params, params, res)
  except:
    raise


def do_kmeanspp(result_q, control_params, params):
    ...
    print(("Executing (pid=%s):" % os.getpid()) + output)
        ...
        for r in range(3):
          ...
          if 'pca' in algorithm:
            for perc in truncated_svd_annz_percentage:
              ...
              try:
                evaluate("kmeanspp", control_params, params_specific['calculate_kmeans'], do_kmeanspp, out_folder)
              except:
...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_path_latex_append_folder', type=str, default="kmeanspp")
  ...
  #result_evaluation_kmeanspp(out_folder, output_path_latex)

  datasets_to_ignore_in_stage1 = {'caltech101': None,
                                  'kdd2001': None,
                                  'mnist800k': None,
                                  'e2006': None}
  result_data = result_evaluation_kmeanspp(out_folder, output_path_latex, ignore_datasets=datasets_to_ignore_in_stage1)
  ...
  result_data = result_evaluation_kmeanspp(out_folder, output_path_latex, remove_incomplete=True)
