...
\\def\\pathpicturesminibatchkmeans{{./pictures/}}
...
"""
      \\begin{{figure}}
        \\centering
        \\input{{\\pathpicturesminibatchkmeans {filename}}}
...
{tables}
  ...
  height=6cm, xlabel={x_label}, ylabel=speedup vs. Mini-Batch \\kmeans{{}}, grid=both, grid style={{line width=.1pt, draw=gray!10}},
...
def create_plot(output_folder=None,
    ...
    reference_times = make_time_percent_reference(pdata, 'minibatch_kmeans', speedup=True)
