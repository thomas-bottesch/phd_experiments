...
\\def\\pathpicturedurationsminibatch{{./{picturesdir}/}}
...
algs_mapping["minibatch_kmeans"] = "Mini-Batch \\kmeans{}"
algs_mapping["pca_minibatch_kmeans"] = "$\\varphi_{p}$ Mini-Batch \\kmeans{}"
algs_mapping["bv_minibatch_kmeans"] = "$\\varphi_{\\B}$ Mini-Batch \\kmeans{}"
...
algorithm_color_mapping = {'bv_elkan':'blue',
                           ...
                           'pca_yinyang': 'red',
                           'yinyang': 'cyan',
                           'minibatch_kmeans': 'blue',
                           'bv_minibatch_kmeans': 'green',
                           'pca_minibatch_kmeans': 'red'}
...
algorithm_position_mapping = {'kmeans': 1,
                              ...
                              'pca_yinyang': 9,
                              'minibatch_kmeans': 10,
                              'bv_minibatch_kmeans': 11,
                              'pca_minibatch_kmeans': 12}
...
def create_picture_line(dataset, no_clusters, run):
  tmpl = "      \\input{{\\pathpicturedurationsminibatch {filename}}}\\begin{{plot{variable_name}}}[]{{\\primaryalg}}{{}}{{\\secondaryalg}}{{}}\\end{{plot{variable_name}}}"
...
def normalize_data(reference_times, reference_algo = 'minibatch_kmeans'):
  for (dataset, no_clusters) in reference_times:
    for run in reference_times[(dataset, no_clusters)]:
